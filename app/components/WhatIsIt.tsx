    ...
    return (
        <section className="py-12 bg-white" aria-labelledby="what-is-it-title">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid md:grid-cols-3 gap-8 mb-12">
                    <div className="bg-gray-50 rounded-lg shadow-md overflow-hidden md:order-1 order-2">
                        <Image
                            src="/placeholder.svg?height=400&width=400"
                    ...
                    <div className="md:col-span-2 bg-gray-50 rounded-lg shadow-md p-6 flex flex-col justify-center md:order-2 order-1">
